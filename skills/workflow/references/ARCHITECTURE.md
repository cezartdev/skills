...
└── .workflow/                          # 📦 [CENTRALIZED WORKFLOW MODULE]
    ...
    │   │       ├── plan.md             # Technical design (Architecture, Schemas & Contracts)
    │   │       ├── tasks.md            # Ordered task breakdown & dependency graph
    │   │       ├── issues/             # Atomic TDD task issues (001_*.md, 002_*.md, etc.)
    ...
    │   ├── workflow_methodology.md     # Methodology, SDD/TDD cycles & execution reference
